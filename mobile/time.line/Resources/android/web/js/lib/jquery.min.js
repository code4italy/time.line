!function(a, b) {
    ...
    m.extend({
        ...
        closest: function(a, b) {
            for (var c, d = 0, e = this.length, f = [], g = t.test(a) || "string" != typeof a ? m(a, b || this.context) : 0; e > d; d++) for (c = this[d]; c && c !== b; c = c.parentNode) if (11 > c.nodeType && (g ? g.index(c) > -1 : 1 === c.nodeType && m.find.matchesSelector(c, a))) {
                f.push(c);
                break;
            }
    ...
    m.extend({
        ...
        queue: function(a, b) {
            var c = 2;
            return "string" != typeof a && (b = a, a = "fx", c--), c > arguments.length ? m.queue(this[0], a) : void 0 === b ? this : this.each(function() {
    ...
    m.event = {
        ...
        trigger: function(b, c, d, e) {
            ...
            p = q.shift(), q.sort()), g = 0 > p.indexOf(":") && "on" + p, b = b[m.expando] ? b : new m.Event(p, "object" == typeof b && b), 
    ...
    m.Animation = m.extend(kc, {
        ...
        for ($b = m.now(); b.length > c; c++) a = b[c], a() || b[c] !== a || b.splice(c--, 1);
    ...
    m.extend({
        ...
        return 0 >= a.offsetWidth && 0 >= a.offsetHeight || !k.reliableHiddenOffsets() && "none" === (a.style && a.style.display || m.css(a, "display"));
